...
export default async function AdminInventoryTransactionsPage({
  params,
  searchParams,
}: {
  ...
  const context = await loadInventoryRouteContext(locale, resolvedSearchParams, "transactions");
  ...
  return (
    <InventoryManager
      ...
      initialSectionGroup="history"
      initialSection="inventory-transactions"
    />
  );
}
