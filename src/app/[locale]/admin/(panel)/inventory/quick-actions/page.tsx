...
export default async function AdminInventoryQuickActionsPage({
  params,
  searchParams,
}: {
  ...
  const context = await loadInventoryRouteContext(locale, resolvedSearchParams, "quick-actions");
  ...
  return (
    <InventoryManager
      ...
      pageVariant="quick-actions"
      initialSectionGroup="overview"
      initialSection="quick-actions"
    />
  );
}
