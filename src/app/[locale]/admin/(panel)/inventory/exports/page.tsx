...
export default async function AdminInventoryExportsPage({
  params,
  searchParams,
}: {
  ...
  const context = await loadInventoryRouteContext(locale, resolvedSearchParams, "exports");
  ...
  return (
    <InventoryManager
      ...
      initialSection="inventory-exports"
    />
  );
}
